...
class UserADO implements EntityInterfaceADO {
    ...
    */
    public function create($user) {
		...
		$arrayValues= [$user->getName(),$user->getSurname1(), $user->getNick(), $user->getPassword(),$user->getRol(), $user->getAddress(), $user->getTelephone(), $user->getMail(), $user->getBirthDate(), $user->getEntryDate(), $user->getDropOutDate(), $user->getActive(), $user->getImage()];
    ...
    */
	 public function update($user) {
		...
		$arrayValues= [$user->getName(),$user->getSurname1(), $user->getNick(), $user->getPassword(),$user->getRol(), $user->getAddress(), $user->getTelephone(), $user->getMail(), $user->getBirthDate(), $user->getEntryDate(), $user->getDropOutDate(), $user->getActive(), $user->getImage(),$user->getId()];
